...
from langchain_ollama import OllamaEmbeddings                       # For generating document embeddings
...
Answer:
"""
PDF_STORAGE_PATH = 'document_store/pdfs/'                       # Path to store uploaded PDFs
EMBEDDING_MODEL = OllamaEmbeddings(model="deepseek-r1:1.5b")    # Use the DeepSeek model for embeddings
DOCUMENT_VECTOR_DB = InMemoryVectorStore(EMBEDDING_MODEL)       # In-memory vector store for document chunks
LANGUAGE_MODEL = OllamaLLM(model="deepseek-r1:1.5b")            # Use the DeepSeek model for language model
