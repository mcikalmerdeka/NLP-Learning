...
# Updated function to generate an answer using LCEL chain (keeping for backward compatibility)
def generate_answer_with_chain(user_query, rag_chain):
    """Generate answer using the RAG chain with LCEL (legacy function)"""
    try:
